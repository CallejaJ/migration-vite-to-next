          ...
          <div className="relative z-10">
            ...
            <div className="grid grid-cols-3 gap-6 lg:gap-8 items-center mb-12 lg:mb-16">
              ...
              <div className="flex justify-center">
                <div className="bg-white p-3 lg:p-4 rounded-2xl shadow-lg transform hover:scale-105 transition-transform animate-float">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-purple-500 to-blue-500 rounded-lg flex items-center justify-center">
              ...
              {/* Logo de Metamask */}
              <div className="flex justify-center">
                <div className="bg-white p-3 lg:p-4 rounded-2xl shadow-lg transform hover:scale-105 transition-transform animate-float-delay">
                  <div className="w-10 h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-orange-500 to-yellow-500 rounded-lg flex items-center justify-center">
            ...
            <div className="absolute top-1/2 left-0 right-0 -mt-px">
              <svg className="w-full" height="2">
                <line x1="0" y1="0" x2="100%" y2="0" stroke="#A78BFA" strokeWidth="2" strokeDasharray="6 6" />
              </svg>
            </div>
            {/* Texto WEB3 */}
            <div className="text-center mt-12 lg:mt-16">
              <div className="font-mono text-xl lg:text-2xl font-bold gradient-text">WEB3</div>
            </div>
            ...
            <div className="absolute inset-0">
              {[0, 60, 120, 180, 240, 300].map((angle, index) => (
                <div
                  key={angle}
                  className={`absolute w-2 h-2 rounded-full ${index % 2 === 0 ? "bg-blue-400" : "bg-purple-400"}`}
                  style={{
        ...
        <div className="lg:flex lg:items-center lg:justify-between lg:gap-12 xl:gap-16">
          ...
          <div className="lg:w-1/2 mb-12 lg:mb-0">
            ...
            <p className="text-gray-600 text-lg mb-8 leading-relaxed">
              Enable secure cryptocurrency transactions on your website with compatibility for any on-chain wallet.
              Backed by advanced encryption, on-chain security, and immutability,{" "}
              <span className="gradient-text font-semibold">Memento Toolkit</span> guarantees peace of mind for every
              transaction.
            </p>
            <Link
              href="/contact"
        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-4">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">
              <span className="gradient-text">Got questions?</span> We're here to assist!
            </h2>
          ...
          <div className="flex justify-center">
            ...
            >
              Send a message
              <svg className="ml-3 w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
              </svg>
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mt-12">
            ...
            <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 border border-blue-100/50 shadow-lg interactive-element">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <h3 className="gradient-text font-semibold text-lg">Quick Response</h3>
            ...
            <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-2xl p-6 border border-purple-100/50 shadow-lg interactive-element">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-left">
                  <h3 className="gradient-text font-semibold text-lg">Expert Support</h3>
                  <p className="text-gray-600 text-sm">Dedicated team with deep Web3 knowledge</p>
                </div>
              </div>
            </div>
          </div>
